  ...
  <nav class="navbar">
    <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
      <a href="index.html" class="flex items-center gap-3">
        ...
        <span class="font-semibold text-[15px] tracking-tight">Voice Authentication System</span>
      </a>
      <div class="hidden md:flex items-center gap-7">
        ...
        <a href="https://github.com/asadullahirshad3/Voice-Authentication-System" target="_blank" rel="noopener" class="nav-link">GitHub <i class="fa-solid fa-arrow-up-right-from-square text-[10px]"></i></a>
      </div>
    ...
    <div id="mobile-sheet" class="mobile-sheet md:hidden">
      ...
      <a href="download.html#core-api" class="nav-link">API</a>
      <a href="#" class="nav-link">Blog</a>
      <a href="https://github.com/asadullahirshad3/Voice-Authentication-System" target="_blank" rel="noopener" class="nav-link">GitHub</a>
      ${authMobile}
    </div>
  </nav>`;
}
...
function renderFooter() {
  ...
  <footer class="border-t border-white/[0.06] mt-12">
    <div class="max-w-7xl mx-auto px-6 py-16 grid grid-cols-2 md:grid-cols-4 gap-10">
      <div class="col-span-2 md:col-span-1">
        <div class="flex items-center gap-3 mb-4">
          <div class="logo-bars"><span></span><span></span><span></span><span></span><span></span></div>
          <span class="font-semibold text-sm">Voice Authentication System</span>
        </div>
      ...
      <div>
        ...
        <ul class="space-y-2 text-sm text-secondary">
          ...
          <li><a href="https://github.com/asadullahirshad3/Voice-Authentication-System" target="_blank" rel="noopener" class="nav-link">GitHub</a></li>
        </ul>
      </div>
      <div>
    ...
    <div class="border-t border-white/[0.06] py-6 text-center text-xs text-muted font-mono">
      Made with Python + PyTorch · ECapa-TDNN · © 2026 Voice Authentication System
    </div>
  </footer>`;
}
